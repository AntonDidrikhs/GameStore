...
namespace GameStore.Controllers
{
    public class GamesController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("Id,Title,Descriprion,ReleaseDate,Genre,Price,Studio")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Descriprion,ReleaseDate,Genre,Price,Studio")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
